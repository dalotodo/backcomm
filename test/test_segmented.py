...
class TestSegmentedCommissionInfo(unittest.TestCase):
    ...
    def setUp(self):
        comm = bc.SegmentedCommissionInfo()
        # Hasta 300 €	1,10 €
        comm.add_segment(None, 300.0, 1.45, 0.0)
        # De 300 a 3.000 €	2,45 € + 2,4PB
        comm.add_segment(300.0, 3000.0, 2.45, 2.4 * bc.PB)
        # De 3.000 a 35.000 €	4,65 € + 1,2PB
        comm.add_segment(3000.0, 35000.0, 4.65, 1.2 * bc.PB)
        # De 35.000 a 70.000 €	6,40 € + 0,7PB
        comm.add_segment(35000.0, 70000.0, 6.40, 0.7 * bc.PB)
        # De 70.000 a 140.000 €	9,20 € + 0,3PB
        comm.add_segment(70000.0, 140000.0, 9.20, 0.3 * bc.PB)
